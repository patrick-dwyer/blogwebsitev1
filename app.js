...
const mongooseURL = "mongodb+srv://" + process.env.MONGODB_USERNAME + ":" + process.env.MONGODB_PASSWORD + "@cluster0.hwe5l.mongodb.net/blogDB"
...
app.get("/posts/:postName", function(req, res){
  ...
  BlogPost.findById(postID, function(err, doc){
    res.render("post", {
      title: doc.title,
      content: doc.content
    });
